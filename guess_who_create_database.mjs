...
VALUES
        ...
        ('wolf', 0, 0, 4, 0, 1, 0, 'carnivore', 1, 'nocturnal', 'grey'),
        ('hamster', 0, 0, 4, 1, 1, 0, 'herbivore', 1, 'crepuscular', 'golden'),
        ('squirrel', 0, 0, 4, 0, 1, 0, 'herbivore', 1, 'crepuscular', 'brown'),
        ('rat', 0, 0, 4, 1, 1, 0, 'omnivore', 1, 'nocturnal', 'grey'),
        ('fox', 0, 0, 4, 0, 1, 0, 'carnivore', 1, 'nocturnal', 'red'),
        ('rabbit', 0, 0, 4, 1, 1, 0, 'herbivore', 1, 'diurnal', 'brown'),
        ('giraffe', 0, 0, 4, 0, 1, 0, 'herbivore', 1, 'diurnal', 'yellow'),
        ...
        ('octopus', 0, 1, 0, 0, 0, 1, 'carnivore', 0, 'nocturnal', 'purple'),
        ...
        ('chicken', 0, 0, 2, 1, 1, 1, 'omnivore', 0, 'diurnal', 'white'),
        ('cheetah', 0, 0, 4, 0, 1, 0, 'carnivore', 1, 'diurnal', 'yellow'),
        ('whale', 0, 1, 0, 0, 1, 0, 'carnivore', 0, 'diurnal', 'black'),
        ('beaver', 0, 1, 4, 0, 1, 0, 'herbivore', 1, 'crepuscular', 'brown');
